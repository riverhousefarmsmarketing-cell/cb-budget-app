    ...
    <div>
      ...
      <div style={{ background: BRAND.white, border: `1px solid ${BRAND.greyBorder}`, padding: '24px', marginBottom: '24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
          ...
          <div>
            <label style={{ display: 'block', fontSize: '12px', color: BRAND.coolGrey, marginBottom: '4px' }}>Target Utilisation (0.00 - 1.00)</label>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '12px', marginBottom: '24px' }}>
        ...
        <KPICard label="Billable Hours" value={empTotalHours.toFixed(0)} />
        <KPICard label="Planned Revenue" value={formatCurrency(empTotalRevenue)} color={BRAND.blue} />
        <KPICard label="Planned Cost" value={formatCurrency(empTotalCost)} />
      ...
      <div style={{ marginBottom: '24px' }}>
        <span style={{ fontSize: '15px', color: BRAND.purple, display: 'block', marginBottom: '12px' }}>Project Assignments</span>
