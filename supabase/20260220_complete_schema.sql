...
-- ============================================================================
-- Architecture follows GoatWise (farm_id) and GoodOfTheOrder (org_id) patterns
-- Tenant isolation key: sector_id
-- All tables use RLS with sector_id-based policies
-- ============================================================================
...
-- ============================================================================
-- Each sector operates as an independent budget unit.
-- New sectors can be added at any time without schema changes.
-- The combined dashboard aggregates across sectors the user has access to.
-- ============================================================================
...
-- Add the FK from timesheet_entries back to uploads
...
-- ============================================================================
-- Pattern: user can only access rows where sector_id matches a sector
-- they belong to via sector_members.
-- Follows the same isolation pattern as:
--   GoatWise:        farm_id + farm_members
--   GoodOfTheOrder:  org_id  + org_members
--
-- ============================================================================
-- HELPER FUNCTION: user_sector_ids()
-- ============================================================================
-- Returns all sector_ids the current authenticated user belongs to.
-- Used in every RLS policy to avoid repeating the subquery.
-- Same pattern as GoatWise user_farm_ids() and GoodOfTheOrder user_org_ids()
-- ============================================================================
...
-- 1. Employee Utilization (monthly)
...
--   2 helper functions (user_sector_ids, user_has_role)
--   5 trigger functions (updated_at, invoice status, overdue, rate audit, forecast conversion)
--   8 updated_at triggers
--   5 database views (utilization, invoice aging, pipeline, capacity, sector summary)
--   2 storage buckets with policies
--   Full PCS sector seed data (16 employees, 7 clients, 12 projects, 12-month calendar, 11 settings)
-- ============================================================================
